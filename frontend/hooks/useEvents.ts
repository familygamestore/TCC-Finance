...
export function useEvents(){
 ...
 const deleteEvent=useCallback(async(id:string)=>{try{await api.deleteEvent(id);await refresh()}catch(e){setError(e instanceof Error?e.message:'Gagal menghapus event')}},[refresh]);
