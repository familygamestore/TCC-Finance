...
Versi ultra dari TCC Finance: UI command center, ledger transaksi, event management, kategori terkontrol, payment-method dropdown, normalisasi tanggal/jam Google Sheets, validasi backend, dan deployment-ready untuk Vercel.

## Deploy
1. Push project ke GitHub.
2. Vercel Root Directory: `frontend`.
3. Node.js: 22.x.
4. Environment: `NEXT_PUBLIC_APPS_SCRIPT_URL`.
5. Deploy ulang Apps Script setelah perubahan `apps-script/Code.gs`.

Next.js 16.2.11 dipakai karena merupakan Active LTS dan patch security Juli 2026.
